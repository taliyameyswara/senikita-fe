...
const CardHeader = ({ item, payment, shipping, type, invoice, date }) => {
    ...
    <div className="pb-2">
      <div className="flex justify-between">
        ...
        <div className="flex items-center gap-2 text-sm">
          <div className="text-gray-400">{type === 'product' ? 'Produk Kesenian' : 'Jasa Kesenian'}</div>
          <div className="text-gray-400">|</div>
          <div className="font-light text-gray-400 font-nunito">{invoice}</div>
          <div className="text-gray-400">|</div>
          <div className="font-light text-gray-400 font-nunito">{formattedDate}</div>
        </div>
