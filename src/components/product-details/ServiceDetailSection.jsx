...
import { IoLocationOutline, IoCash, IoCalendarOutline, IoSwapHorizontalOutline, IoTimeOutline, IoCashOutline } from "react-icons/io5";
import { BsTruck } from "react-icons/bs";
// export declare const IoCashOutline: IconType;
// export declare const IoCashSharp: IconType;
// export declare const IoCash: IconType; IoCalendarOutline IoSwapHorizontalOutline IoTimeOutline
const ServiceDetailSection = ({ service }) => {
    // const imageServices = service.images ? [service.thumbnail, ...service.images] : service.thumbnail
    const imageServices = service.images && service.images.length > 0
            ...
            <div className="flex flex-col">
                ...
                <div className="flex gap-2 mb-2 text-sm">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <div className="text-sm font-nunito">{service.rating_count}</div>
                        <div className="text-sm text-gray-500 font-nunito">
                            ({service.ratings.length} Rating)
                            {/* (Menunggu Backend Rating) */}
                        </div>
                    </div>
                </div>
